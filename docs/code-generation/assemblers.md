...
Code assemblers are a thin layer above [laminas/laminas-code](https://github.com/laminas/laminas-code).
...
You can use the [laminas/laminas-code](https://github.com/laminas/laminas-code) `ClassGenerator` and `FileGenerator` to manipulate your code.
